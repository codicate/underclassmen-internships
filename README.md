...
| Name                                                                                                                                                        | Status/Open Date   | Year                | Note                                                                                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Keploy API Fellowship](https://fellowship.keploy.io/)                                                                                                      | ✅ Open            | All student         | A training program for you to get into the world of APIs, building in public, and GSoC prep. Through phased learning, hands-on projects, and assignments, participants gain practical skills to excel in APIs                          |
